"""
Command Execution Tool - Execute shell commands with whitelist validation.

This tool provides secure command execution for the LLM with:
- Command whitelist (patterns and fully qualified command names)
- Parameter support for whitelisted commands
...
TOOL_DEFINITION = {
    ...
    "function": {
        "name": "command_exec",
        "description": "Execute shell commands with whitelist validation. Only whitelisted commands can be executed. Supports command parameters and captures output.",
        "parameters": {
            "type": "object",
            "properties": {
                "command": {
                    "type": "string",
                    "description": "Command to execute (e.g., 'ls', 'grep', 'find')"
                },
                "arguments": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Command arguments as array of strings (e.g., ['-la', '/path'])"
                },
                "timeout": {
                    "type": "integer",
