...
- How To documents
   - [How to add functionality to the LLM, such as updating files and Intenet access](docs/HOW_TOs/Setup_Tools.md)
   ...
   - [How to talk to the LLM and have it talk back (voice2text / text2voice)](docs/HOW_TOs/Setup_Talking.md)
   - [Use all these tools with ChatGTP (external LLM usage)](docs/HOW_TOs/Setup_External_LLM.md)
