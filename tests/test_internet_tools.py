...
class TestInternetDuckDuckGo:
    """Test internet_duckduckgo tool."""

    def test_load_tool_module(self):
        """Test loading the duckduckgo tool module."""
        manager = ToolsManager()
        module = manager.load_tool_module('internet_duckduckgo')
...
class TestInternetGoogleWebscrape:
    """Test internet_google_webscrape tool."""

    def test_load_tool_module(self):
        """Test loading the google webscrape tool module."""
        manager = ToolsManager()
        module = manager.load_tool_module('internet_google_webscrape')
...
class TestInternetGoogleAPI:
    """Test internet_google_api tool."""

    def test_load_tool_module(self):
        """Test loading the google API tool module."""
        manager = ToolsManager()
        module = manager.load_tool_module('internet_google_api')
...
class TestToolsRegistry:
    ...
    def test_internet_tools_in_registry(self):
        ...
        # Check duckduckgo
        ddg_info = manager.get_tool_info('internet_duckduckgo')
        ...
        google_info = manager.get_tool_info('internet_google_webscrape')
        ...
        # Check google API
        google_api_info = manager.get_tool_info('internet_google_api')
    ...
    def test_get_enabled_llm_invokable_tools_when_disabled(self):
        ...
        assert 'internet_duckduckgo' not in tool_names
        assert 'internet_google_webscrape' not in tool_names
        assert 'internet_google_api' not in tool_names
